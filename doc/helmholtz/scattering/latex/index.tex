...
Using (4), it is easy to show (see, e.\+g., J. Jin \char`\"{}\+The Finite Element Method in Electromagnetics (second edition)\char`\"{}, Wiley (2002) p. 501ff -- but note that Jin assumes that the potential varies like $ \exp(i\omega t)$ rather than $ \exp(-i\omega t)$ as assumed here) that the normal (radial) derivative, $ \partial u / \partial n =   
