...
\ \ \ \ \ \ \ \ \  (4)
\] so that $u_0(x_1,x_2) $ represents the exact solution of the problem.   \\\cline{1-1}
\end{longtabu}
~\newline
 \end{center} 
...
\end{array}
 \right.
\] Accurate numerical solution can therefore only be obtained if the mesh is refined -- ideally only in the vicinity of the \char`\"{}step\char`\"{}\+:
...
\DoxyCodeLine{\textcolor{comment}{///\ Refineable\ equivalent\ of\ the\ SimpleRectangularQuadMesh.}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{///\ Refinement\ is\ performed\ by\ the\ QuadTree-\/based\ procedures}}
\DoxyCodeLine{\textcolor{comment}{///\ implemented\ in\ the\ RefineableQuadMesh\ base\ class.}}
...
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classSimpleRefineableRectangularQuadMesh}{SimpleRefineableRectangularQuadMesh}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{unsigned}\ \&Nx,}
...
\DoxyCodeLine{\textcolor{comment}{///\ refineable\ 2D\ QPoisson\ elements.\ The\ specific\ type\ of\ element\ is}}
...
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classRefineablePoissonProblem}{RefineablePoissonProblem}}(PoissonEquations<2>::PoissonSourceFctPt\ }
...
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classSimpleRefineableRectangularQuadMesh}{SimpleRefineableRectangularQuadMesh<ELEMENT>}}*\ \mbox{\hyperlink{classRefineablePoissonProblem_a3cde3ea5577b065e081eb74ff870b5c3}{mesh\_pt}}()\ }
\DoxyCodeLine{\ \ \{}
