...
\ \ \ \ \ \ \ \ \  (4)
\] is the exact solution of the problem. The plot below shows the numerical solution for $\Phi=45^\circ $, a Peclet number of $\mbox{Pe}= 200 $, and four different values of the \char`\"{}steepness parameter\char`\"{}, $ \alpha =  0.2,\ 5,\ 10 $ and $ 15 $.
