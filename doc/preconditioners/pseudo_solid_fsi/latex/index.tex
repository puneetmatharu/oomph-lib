...
\end{DoxyItemize}Using this classification of the unknowns, the linear system to be solved in the course of the Newton iteration can be re-\/ordered into the following block structure\+:  \[
...
\right]
\ \ \ \ \ \ \ \ \ \ \ \ \ \ (2)
\] which we discussed in \href{../../prescribed_displ_lagr_mult/html/index.html}{\texttt{ another tutorial}}. This yields the pseudo-\/solid FSI preconditioner  \[
{\cal P}_{\rm FSI}=\left[
\begin{array}{c|c|cc}
F& &C_{\rm fx}&\\ \hline
...
\end{DoxyCodeInclude}
 If Hypre is available, we can then (approximately) solve the diagonal blocks using a small number of AMG V-\/cycles (with settings specified in the helper function {\ttfamily \mbox{\hyperlink{namespaceLSC__Preconditioner__Helper_a3ddbb4dc9864cc9ce3901001447560a0}{LSC\+\_\+\+Preconditioner\+\_\+\+Helper\+::set\+\_\+hypre\+\_\+preconditioner}}})\+:
...
\DoxyCodeLine{\ \ \ \ (\mbox{\hyperlink{namespaceLSC__Preconditioner__Helper_a3ddbb4dc9864cc9ce3901001447560a0}{LSC\_Preconditioner\_Helper::set\_hypre\_preconditioner}});}
