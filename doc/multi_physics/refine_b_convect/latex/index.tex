...
We start by setting the direction of gravity, and constructing the problem using the new \mbox{\hyperlink{index_element}{Refineable\+Buoyant\+QCrouzeix\+Raviart\+Elements}}, described \href{\#element}{\texttt{ below.}}
...
\DoxyHorRuler{0}
 \DoxyHorRuler{0}
\hypertarget{index_element}{}\doxysection{Creating the new Refineable\+Bouyant\+QCrouzeix\+Raviart\+Element class}\label{index_element}
...
\item Try using {\ttfamily Refineable\+QTaylor\+Hood\+Elements} as the \char`\"{}fluid\char`\"{} element part of the multi-\/physics elements.
