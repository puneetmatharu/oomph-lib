...
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ Build\ a\ refineable\ Navier\ Stokes\ element\ that\ inherits\ from}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ ElementWithExternalElement\ so\ that\ it\ can\ "{}communicate"{}\ with}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ an\ advection\ diffusion\ element\ that\ provides\ the\ temperature}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ in\ the\ body\ force\ term.}}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ Ra\_pt\ =\ \&MultiDomainBoussinesqHelper::Default\_Physical\_Constant\_Value;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ ///\ buoyancy\ force,\ using\ the\ temperature\ computed\ by\ the}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ ///\ "{}external"{}\ advection\ diffusion\ element\ associated\ with}}
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ ///\ integration\ point\ \(\backslash\)c\ ipt.}}
...
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ Build\ an\ AdvectionDiffusionElement\ that\ inherits\ from}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ ElementWithExternalElement\ so\ that\ it\ can\ "{}communicate"{}\ with\ the}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ a\ NavierStokesElement\ that\ provides\ its\ wind.}}
\DoxyCodeLine{\textcolor{comment}{}\ \ \textcolor{comment}{//=====================================================================}}
...
\DoxyCodeLine{\textcolor{comment}{\ \ \ \ ///\ obtained\ from\ the\ "{}external"{}\ element}}
...
\DoxyCodeLine{\textcolor{comment}{\ ///\ Casts\ the\ pointer\ to\ the\ base\ Mesh\ object\ to\ }\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ Overload\ the\ function\ that\ must\ return\ all\ field\ data\ involved}\textcolor{comment}{}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ in\ the\ interaction\ with\ the\ external\ (Navier\ Stokes)\ element.}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ Only\ the\ velocity\ dofs\ in\ the\ Navier\ Stokes\ element\ affect\ the}}
\DoxyCodeLine{\textcolor{comment}{\ \ ///\ interaction\ with\ the\ current\ element.}}
\DoxyCodeLine{\textcolor{comment}{}\ \ \textcolor{comment}{//=======================================================================}}
\DoxyCodeLine{\ \ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ AD\_ELEMENT,\ \textcolor{keyword}{class}\ NST\_ELEMENT>}
