...
\big\{(x_1,x_2) \ | \ x_2=1 \big\} $ , and apply periodic boundary condition on the \char`\"{}left\char`\"{} and \char`\"{}right\char`\"{} boundaries\+:  \[
