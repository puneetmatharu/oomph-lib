...
\right),
 \ \ \ \ \ \ \ \ \ \ (5)
\] where the \char`\"{}ramp\char`\"{} function  \[
{\cal R}(t) =  \left\{
\begin{array}{ll}
...
\end{array}
\right.
\] is used to facilitate the start-\/up of the simulation from the initial condition of steady Poiseuille flow. $ {\cal R}(t) $ provides a \char`\"{}smooth\char`\"{} startup of the wall motion during the first period of the oscillation.
...
6 \ x_2 \ (1-x_2) \ {\bf e}_1 $ ; see \mbox{\hyperlink{index_comments}{Comments and Exercises}}. 
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{}
