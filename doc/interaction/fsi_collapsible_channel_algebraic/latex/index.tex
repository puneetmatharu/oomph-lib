...
We note that the {\ttfamily Geom\+Object} base class provides a default implementation for the {\ttfamily Geom\+Object\+::locate\+\_\+zeta(...)} function as a virtual member function which returns the {\ttfamily Geom\+Object\textquotesingle{}s} {\ttfamily \char`\"{}this\char`\"{}} pointer and sets $ \zeta_{compound} =
