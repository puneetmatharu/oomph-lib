...
To solve this problem with {\ttfamily oomph-\/lib} \mbox{[}Yes, the solution is $ Y_c = f_{load}/k_{stiff}$ but let\textquotesingle{}s pretend we don\textquotesingle{}t know this...\mbox{]}, we employ C++ inheritance to \char`\"{}upgrade\char`\"{} the {\ttfamily General\+Circle} object, discussed above, to a {\ttfamily Generalised\+Element} in which the vertical position of the ring, $ Y_c
...
\DoxyCodeLine{\ \textcolor{keywordtype}{void}\ set\_load\_pt(Data*\ load\_pt)}
\DoxyCodeLine{\ \ \{}
\DoxyCodeLine{\textcolor{preprocessor}{\#ifdef\ PARANOID}}
...
\DoxyCodeLine{\ \textcolor{keywordtype}{void}\ fill\_in\_generic\_residual\_contribution(Vector<double>\ \&residuals,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ DenseMatrix<double>\ \&jacobian,}
...
\DoxyCodeLine{\ problem.\mbox{\hyperlink{classGeomObjectAsGeneralisedElementProblem_a47149c35c94b2ab99507a0a74fe35823}{load}}()=-\/0.3;}
\DoxyCodeLine{\ }
...
\DoxyCodeLine{\ \ \ problem.\mbox{\hyperlink{classGeomObjectAsGeneralisedElementProblem_af21708459753b56b407f4e70d1cfe795}{doc\_info}}().number()++;\ \ \ \ }
\DoxyCodeLine{\ \ \ }
\DoxyCodeLine{\ \ \ \textcolor{comment}{//\ Change\ load\ on\ ring}}
\DoxyCodeLine{\ \ \ problem.\mbox{\hyperlink{classGeomObjectAsGeneralisedElementProblem_a47149c35c94b2ab99507a0a74fe35823}{load}}()+=dp;}
\DoxyCodeLine{\ \ \}\ }
\DoxyCodeLine{\ }
...
\DoxyCodeLine{\textcolor{comment}{}\ DocInfo\&\ \mbox{\hyperlink{classGeomObjectAsGeneralisedElementProblem_af21708459753b56b407f4e70d1cfe795}{doc\_info}}()\ \{\textcolor{keywordflow}{return}\ \mbox{\hyperlink{classGeomObjectAsGeneralisedElementProblem_a89a7f5fa555839193166f802d6ff6be2}{Doc\_info}};\}}
\DoxyCodeLine{}
