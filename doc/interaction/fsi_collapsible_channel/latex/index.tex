...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Vector<double>\&\ N,\ Vector<double>\&\ load)}
\DoxyCodeLine{\ \{\ }
...
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classUndeformedWall}{UndeformedWall}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\&\ x0,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\&\ h):\ GeomObject(1,2)}
\DoxyCodeLine{\ \ \{}
...
\DoxyCodeLine{\textcolor{comment}{}\ \mbox{\hyperlink{classFSICollapsibleChannelProblem}{FSICollapsibleChannelProblem}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{unsigned}\&\ nup,\ }
...
~\newline
 In the section \mbox{\hyperlink{index_fsi_wall_elements}{Applying the fluid-\/traction to the wall elements\+: FSIWall\+Elements}} we briefly discussed how the function {\ttfamily FSI\+\_\+functions\+::setup\+\_\+fluid\+\_\+load\+\_\+info\+\_\+for\+\_\+solid\+\_\+elements(...)} determines the variables that affect the fluid traction onto the {\ttfamily FSIWall\+Elements}. For a Newtonian fluid, the components of the fluid traction vector (on the viscous scale) onto the wall is given by  \[
  ...
  \mbox{ \ \ \ for $i=1,2[,3]$} 
  \] where $ N_i \ (\mbox{for } i=1,2[,3]) $ are the components of the normal to the fluid domain, pointing into the fluid. This equation shows that the fluid traction is primarily affected by the velocity and pressure degrees of freedom in the fluid elements that are \char`\"{}adjacent\char`\"{} to a given {\ttfamily FSIWall\+Element}. ~\newline
~\newline
